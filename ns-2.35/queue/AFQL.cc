...
static class AFQLClass : public TclClass {
public:
        AFQLClass() : TclClass("Queue/AFQL") {}
        TclObject* create(int, const char*const*) {
            fprintf(stderr, "Created new TCL AFQL instance\n"); // Debug: Peixuan 07062019
	        return (new AFQL);
	}
} class_hierarchical_queue;

AFQL::AFQL():AFQL(DEFAULT_VOLUME) {
    fprintf(stderr, "Created new AFQL instance\n"); // Debug: Peixuan 07062019
}
...
int AFQL::cal_theory_departure_round(hdr_ip* iph, int pkt_size) {
    //int		fid_;	/* flow id */
    //int		prio_;
    // parameters in iph
    // TODO
